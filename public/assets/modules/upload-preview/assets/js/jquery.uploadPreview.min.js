    ...
    e.extend({
        uploadPreview: function (l) {
            ...
            return window.File && window.FileList && window.FileReader
                ? void(void 0 !== e(i.input_field) && null !== e(i.input_field) && e(i.input_field).change(function () {
                    var l = this.files;
                    if (l.length > 0) {
                        var a = l[0],
                            o = new FileReader;
                        o.addEventListener("load", function (l) {
                            ...
                            a.type.match("image")
                                ...
                                :(a.type.match("pdf")?(e(i.preview_box).css("background-image", "url('/images/pdf_photo.png')"), e(i.preview_box).css("background-size", "cover"), e(i.preview_box).css("background-position", "center center")):(a.type.match("audio")
